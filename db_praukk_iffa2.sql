...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2023 at 09:05 AM
...
(5, 'ytytr', 'ghn', 7645, '2023-02-01', '2023-03-07', 765),
(6, 'uytu6', 'u6', 64, '2023-02-09', '2023-02-01', 3234),
(7, 'ytytr', 'rwerw', 765, '2023-03-07', '2023-03-09', 754),
(8, 'ghj', 'ty', 234, '2023-02-02', '2023-02-08', 7567),
(9, 'ui', 'yuio', 5446, '2023-01-31', '2023-02-15', 78689),
(10, 'ol', 'ikl', 1443, '2023-02-08', '2023-02-28', 3424),
(12, 'tet', 'rt4rt', 876, '2023-02-07', '2023-03-08', 765);
...
--
ALTER TABLE `tb_dvd`
  MODIFY `id_dvd` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `tb_penyewa`
  ...
  ADD CONSTRAINT `tb_penyewa_ibfk_2` FOREIGN KEY (`id_penyewa`) REFERENCES `tb_dvd` (`id_dvd`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
